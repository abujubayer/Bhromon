...
namespace Poth_Dekho
{
    public partial class tour_guide_profile_details : Form
    {
        ...
        void reload()
        {
            ...
            string query = "select * from TourGuideRegi where IdNo=@IdNo";
        ...
        */
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            string query = "update TourGuideRegi set Username=@username, Email=@email, Phone=@phone, Password=@password";
            SqlCommand cmd = new SqlCommand(query, con);
        ...
        private void tour_guide_profile_details_Load(object sender, EventArgs e)
        {
